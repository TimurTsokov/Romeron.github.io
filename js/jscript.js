...
// 
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > '10') {
            $('.nav').css({"position": "fixed", "z-index": "980", "width": "100%", "margin-top": "-150px"});
            $('.link').css({"margin": "0"});
            $('.list__katalog').css({"margin-top": "-8px"});

        } else if ($(window).scrollTop() < '10') {
            $('.nav').css({"position": "static", "width": "auto", "margin-top": "0"});
            $('.link').css({"margin": "18px 0 18px 0"});
            $('.list__katalog').css({"margin-top": "0"});
        }
    })
